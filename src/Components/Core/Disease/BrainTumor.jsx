            ...
            {!selectedImage ? (
              ...
              <>
                <div className="w-full h-auto rounded-[15px] mb-4 overflow-hidden">
                  <img src={URL.createObjectURL(selectedImage)} alt="Uploaded" className="w-full h-auto" />
                </div>
                <div className='text-lg md:text-3xl bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-600 text-center font-sans font-bold uppercase tracking-[1px] mt-2 mb-4'>{isLoading ? 'Predicting...' : predictionResult}</div>
              </>
            )}
            <div
