        ...
        <div>
          <div className="p-3 lg:p-0">
            ...
            <p className="select-none text-neutral-500 max-w-lg mx-auto text-lg lg:text-[1.25rem] tracking-[1px] font-ai p-3 lg:p-0 text-justify">
              ...
              , your personal Tuberculosis Detector. I specialize in providing support and guidance for individuals concerned about tuberculosis risk assessment. Whether you seek insights into symptoms, risk factors assessment, or preventive measures,{" "}
              <span className="uppercase font-bold floating-animation gemini-font">
                TuboCheck
              </span>{" "}
              is here to assist you every step of the way. The name TuboCheck reflects our dedication to Tuberculosis awareness and proactive health management.
            </p>
          </div>
