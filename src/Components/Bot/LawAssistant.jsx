...
const LawAssistant = () => {
    ...
    const [history, setHistory] = useState([
        {
            role: "user",
            parts: "Hello, You need to act like a Health Law Advisor who has all knowledge of Health laws applicable in India. I may ask for what steps or law proceedings should I take in case of any help in health law. You should also provide me reference of which law I should take. If I ask you out of topic question simple give reply like Sorry I am just your Health Law Advisor",
        },
        {
            role: "model",
        ...
        <div className="h-full min-h-[100vh] w-full rounded-md bg-neutral-950 flex flex-col items-center justify-center antialiased">
            <div className="max-w-7xl mx-auto">
                ...
                <p className="text-neutral-500 max-w-lg mx-auto my-1 text-lg text-center tracking-[1px] font-ai">
                    Welcome to <span className='uppercase font-bold floating-animation gemini-font'>Jurix</span>, your trusted Health Law Advisor. We specialize in providing legal support and guidance for individuals navigating the complexities of healthcare law. Whether you're a healthcare professional, a patient, or involved in healthcare administration, <span className='uppercase font-bold floating-animation gemini-font'>Jurix</span> is here to help you understand your rights, obligations, and legal options. Our mission is to empower you with knowledge and confidence in the realm of health law.
                </p>
                ...
                <TracingBeam containerRef={chatContainerRef}>
                    <div className='w-7xl flex flex-col gap-x-2 border border-white rounded-[30px] overflow-hidden p-12 mt-[5%]'>
                        ...
                        <div className="chat-container max-h-[300px] overflow-y-auto mt-[2%]" ref={chatContainerRef}>
                            ...
                            {!loading && history.slice(1).map((message, index) => (
