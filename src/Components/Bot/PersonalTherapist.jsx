...
const genAI = new GoogleGenerativeAI(`AIzaSyAekZwuOWfD418tH158IdFAxZinVeyKifc`);
...
const PersonalTherapist = () => {
  ...
  return (
    <div className="h-full min-h-[100vh] w-full rounded-md bg-neutral-950 flex flex-col items-center justify-center antialiased">
      {/* <BackgroundBeams /> */}
      <div className="max-w-7xl mx-auto border-collapse border-grey-200">
        ...
        <p className="text-neutral-500 max-w-lg mx-auto my-2 text-sm text-center tracking-[1px]">
          ...
          your compassionate guide on the journey to mental well-being. We
          specialize in providing support and guidance for individuals seeking
          relief from mental health challenges. Whether you're in need of
          empathetic listening, personalized coping strategies, or a safe space
          to explore your emotions,{" "}
          <span className="uppercase font-bold">Mediquity</span> is here for you
          every step of the way.
        </p>

        <div className="w-6xl flex flex-col gap-x-2">
          {history.map((message, index) => (
            ...
            >
              ...
              <div
                className={`bg-black p-4 rounded-[15px] max-w-[70%] ${
          ...
          <form
            ...
            className="w-full flex place-items-center justify-center mt-[2%] gap-x-2"
          >
            <input
              type="text"
              value={newMessage}
