        ...
        <div>
          <div className="p-3 lg:p-0">
            ...
            <p className="select-none text-neutral-500 max-w-lg mx-auto text-lg lg:text-[1.25rem] tracking-[1px] font-ai p-3 lg:p-0 text-justify">
              ...
              , your personal Brain Tumor Detector. I specialize in providing support and guidance for individuals concerned about brain tumor risk assessment. Whether you seek insights into symptoms, risk factors assessment, or preventive measures,{" "}
              <span className="uppercase font-bold floating-animation gemini-font">
                TumoDetect
              </span>{" "}
              is here to assist you every step of the way. The name TumoDetect reflects our dedication to brain tumor awareness and proactive health management.
            </p>
