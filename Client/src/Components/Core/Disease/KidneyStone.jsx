...
const KidneyStoneDetection = () => {
  ...
  const predictOsteoporosis = async () => {
    ...
    try {
      const response = await fetch("http://127.0.0.1:5000/predict/kidney-stone", {
        method: "POST",
        body: formData,
      });
        ...
        <div>
          <div className="p-3 lg:p-0">
            ...
            <p className="select-none text-neutral-500 max-w-lg mx-auto text-lg lg:text-[1.25rem] tracking-[1px] font-ai p-3 lg:p-0 text-justify">
              ...
              , your personal Kidney Stone Detector. I specialize in providing support and guidance for individuals concerned about Kidney Stone risk assessment. Whether you seek insights into symptoms, risk factors assessment, or preventive measures,{" "}
              <span className="uppercase font-bold floating-animation gemini-font">
                KidStoCheck
              </span>{" "}
              is here to assist you every step of the way. The name KidStoCheck reflects our dedication to Kidney Stone awareness and proactive health management.
            </p>
          </div>
...
export default KidneyStoneDetection;
