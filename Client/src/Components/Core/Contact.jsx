...
const GlobeDemo = React.lazy(() =>
  import("../Common/ContactUs").then((module) => ({
    default: module.GlobeDemo,
  }))
);
...
export const Contact = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row lg:min-h-screen h-full lg:min-w-screen bg-black overflow-clip">
      <div className="lg:w-[50%] w-[90%] flex flex-col lg:ml-16 mx-auto mb-4">
        <div className="lg:w-[55%] w-[90%] h-fit rounded-[30px] mt-16 mx-auto border p-6 ">
          <h2 className="select-none text-4xl lg:text-5xl pt-[4%] bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-600 text-center font-sans font-bold uppercase tracking-[1px] mb-[2.5%]">
            Feedback Form
          </h2>
          ...
          <form onSubmit={handleSubmit(submitContactForm)}>
            ...
            <div className="flex flex-col gap-2 mt-7">
              ...
              <textarea
                ...
                className=" rounded-lg bg-zinc-800 placeholder:pl-4 pl-4 py-3 placeholder:tracking-[1px] border border-gray-100 placeholder:pt-3 text-white placeholder:text-2xl placeholder:font-ai"
      ...
      <div className="lg:w-[50%] w-[100%] ipad:mb-16">
